<div id="cart" class="btn-group btn-block">
    <div class="cart-heading dropdown-toogle" data-hover="dropdown" data-toggle="dropdown">
        <span>
            <p style="float: left;margin:0; " class="hidden-sm hidden-md"><?php echo $text_wds_view_cart; ?></p>
            <span id="cart-total" style="float: right;"><?php echo $text_items; ?></span>
        </span>
    </div>
        ...
        <?php if ($products || $vouchers) { ?>
            ...
            <li>
                <div>
                    ...
                    <p class="text-right"><a class="button" href="<?php echo $cart; ?>"><strong><i
                                    class="fa fa-shopping-cart"></i> <?php echo $text_cart; ?></strong></a>&nbsp;&nbsp;&nbsp;<a
                            href="<?php echo $checkout; ?>" class="button"><strong><i
