        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <a onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-category').submit() : false;" class="btn btn-danger"><i class="fa fa-trash"></i> <?php echo $button_delete; ?></a>
                </div>
                                ...
                                <?php if($categories) { ?>
                                    <?php foreach ($categories as $category) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo $category['edit']; ?>"  class="btn btn-primary"><i class="fa fa-pencil"></i> <?php echo $button_edit; ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
