        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <a onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-comment').submit() : false;" class="btn btn-danger"><i class="fa fa-trash"></i> <?php echo $button_delete; ?></a>
                </div>
                                ...
                                <?php if($comments) { ?>
                                    <?php foreach ($comments as $comment) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo $comment['edit']; ?>"  class="btn btn-primary"><i class="fa fa-pencil"></i> <?php echo $button_edit; ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
